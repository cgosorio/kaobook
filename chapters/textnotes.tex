...
what we said for marginnotes is also valid for sidenotes. The position of side- and 
margin- notes can be shifted slightly upwards in needed
...
\ifcsdef{cgotrue}{}{\newif\ifcgo\cgofalse}\ifcgo
\section{Marginquotes}

\marginquote[-7mm]{This is the text of the cite}{This is the author}

These are two new commands: \verb|\marginquote| and \verb|\cleanchapterquote|,
for formatting quotes that I, César Ignacio García Osorio, have introduced to
be able to use in the first page of a chapter, although it can be used in other
context. The first if for showing the quote at the margin:

\begin{lstlisting}[language=tex,style=kaolstplain,showspaces=true]
\marginquote[-7mm]{This is the text of the quote
    that will appear on the margin}{This is the author}
\end{lstlisting}

The second for showing the quotes on the main body of the page.

\begin{lstlisting}[language=tex,style=kaolstplain,showspaces=true]
\cleanchapterquote{This is the text of the cite that I am
    making a bit longer, since for cites in the main body
    of the page looks better if the quote expands several
    lines}{This is the author}
\end{lstlisting}

\cleanchapterquote{This is the text of the cite that I am making a bit longer, since for cites in the main body of the page looks better if the quote expands several lines}{This is the author}
\fi % /ifcgo
