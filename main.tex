...
\else
    \ifspanish
        % Using this with microtype gives «! Argument of \MT@res@a has an extra }» in pdflatex
        % Commeting mircotype gives «TeX capacity exceeded, sorry [input stack size=5000]»
...
\fi
\ifspanish
    \usepackage[autostyle=true]{csquotes}  % To use babel or polyglossia language
\else
